...
let AdController = class AdController {
    ...
    ;
    async updateAds(id, update) {
        const advertisement = await entity_1.default.findOne(id);
        if (!advertisement)
            throw new routing_controllers_1.NotFoundError('Cannot find advertisement');
        return entity_1.default.merge(advertisement, update).save();
    }
    ;
    createAds(advertisement) {
...
], AdController.prototype, "allAds", null);
__decorate([
    ...
    __metadata("design:returntype", Promise)
], AdController.prototype, "updateAds", null);
__decorate([
    ...
    __metadata("design:returntype", void 0)
], AdController.prototype, "createAds", null);
